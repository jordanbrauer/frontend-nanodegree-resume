...
var HTMLemail = '<li class="flex-item"><i class="fa fa-md fa-envelope"></i> <span class="white-text">%data%</span></li>';
var HTMLtwitter = '<li class="flex-item"><i class="fa fa-md fa-twitter"></i> <span class="white-text">%data%</span></li>';
var HTMLgithub = '<li class="flex-item"><i class="fa fa-md fa-github"></i> <span class="white-text">%data%</span></li>';
var HTMLlocation = '<li class="flex-item"><i class="fa fa-md fa-map-marker"></i> <span class="white-text">%data%</span></li>';
